...
const DDOUBLE INFINITY_LIMIT = 1e+300;
const DDOUBLE ZERO_LIMIT_2ORDER = 1e-4;
...
public:
    ...
    vector3d set(DDOUBLE x, DDOUBLE y, DDOUBLE z) {
        v[0] = x;
        v[1] = y;
        v[2] = z;
        return *this;
    ...
    vector3d tolen(DDOUBLE newlen) {
        return ((*this) / len()) * newlen;
    }
...
vector3d projPointPlain(vector3d p, vector3d a, vector3d b, vector3d c);
